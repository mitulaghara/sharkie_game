...
export default class UI {
    ...
    playClick() {
        if (!this.game.sounds) {
            ...
            gsap.to(document.getElementById('opening-screen'), {
                opacity: 0,
                duration: .4
            })
            setTimeout(() => {
    ...
    showWinContainer() {
        ...
        gsap.fromTo(document.getElementById('win-sharkie'), {
    ...
    showDeadContainer() {
        ...
        /**animation */
        gsap.fromTo(this.deadContainer, {
            opacity: 0
        }, {
            opacity: 1,
            delay: 2,
    ...
    fadeInBossHealthbar() {
        ...
        gsap.fromTo(document.getElementById('final-boss-health-bar-container'), {
            opacity: 0,
        }, {
            opacity: 1,
            duration: 0.5,
